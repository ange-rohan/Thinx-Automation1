...
${MeetBrandsNav}       //div[@class='lg:flex lg:justify-between lg:gap-x-[144px] lg:gap-y-4 lg:flex-wrap']/div[@class='lg:w-[150px] hidden lg:block']//a[.='explore our brands']
...
${PeriodProductCard1}      //img[@alt='ultra soft hi-waist underwear front model view']
